...
const hebrewWords = [
  ...
  "אשכול", "אתריה", "בדיוק", "בזמני", "בלשון", "בפנים", "בצורה", "בשביל", "גבריל", "גדולה",
  "גלויה", "גמורה", "גפרור", "דגושה", "דמיון", "וסכום", "זהובה", "זכותי", "זעירה", "זקוקה",
  "זרועי", "חבורה", "חדישה", "חזיתי", "חנותי", "חסידי", "חפירה", "חצובי", "חקלאי", "חריפי",
  "חשובי", "טבעיי", "טובתי", "טיוחי", "טלפני", "טעותי", "טקסיס", "טמטום", "לימון", "ילקוט",
  "קיטור", "מסטיק", "מחברת", "תרמיל", "שלטון", "מגבתים", "כדורגל", "ארמון", "קבוצה", "מדינה", "עוגיות", "מקלחת", "מזנון", "רשימה",
  "עפרון", "כינור", "חליפה", "צלחת", "מצעים", "קמחית", "גשמים", "כריתך", "ברווז",
  "דובון", "עכבר", "מדפים"
];
